      ...
      <div class="row gx-0 gy-6 g-lg-10">
        ...
        <div class="col-lg-5">
          ...
          <p class="footer-text footer-logo-description mb-6">
            One secure dashboard to manage multiple Demat accounts with complete read-only access and insights.
          </p>
        ...
        <div class="col-lg-2 col-md-4 col-sm-6">
          ...
          <ul class="list-unstyled">
            <li class="mb-4"><span class="footer-link">Retail Investors</span></li>
            <li class="mb-4"><span class="footer-link">Pro Investors</span></li>
            <li class="mb-4"><span class="footer-link">Advisors</span></li>
            <li class="mb-4"><span class="footer-link">Security & Privacy</span></li>
            <li class="mb-4"><span class="footer-link">Compliance Ready</span></li>
          </ul>
        </div>

        <!-- Resources -->
        <div class="col-lg-2 col-md-4 col-sm-6">
          <h6 class="footer-title mb-6">Resources</h6>
          <ul class="list-unstyled">
            <li class="mb-4"><span class="footer-link">Pricing Plans</span></li>
            <li class="mb-4"><span class="footer-link">FAQs</span></li>
            <li class="mb-4"><span class="footer-link">Help Center</span></li>
            <li class="mb-4"><span class="footer-link">Product Updates</span></li>
            <li class="mb-4"><span class="footer-link">Support</span></li>
          </ul>
        </div>

        <!-- Mobile App -->
        <div class="col-lg-3 col-md-4">
          <h6 class="footer-title mb-6">Mobile App</h6>
